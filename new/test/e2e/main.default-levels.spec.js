...
test("Via menu", async t => {
  await t
      ...
      .expect(indexPage.levelIndicator.textContent).notContains("1 - Level 1 (password: tcP)")
      .click(indexPage.menu.loadDefaultLevels)
      .expect(indexPage.levelIndicator.textContent).contains("1 - Level 1 (password: tcP)");
});
