...
fixture`Left menu password entering`.page("http://localhost:5555/");

const indexPage = new IndexPage();

test("enter bad password", async (t) => {
  await t
    .expect(indexPage.layout.visible)
    .ok()
    ...
    .expect(indexPage.messageBar.text.textContent)
    .contains("Couldn't find a level with password wrong.");
});
